...
class Application(tk.Frame):
    def __init__(self, master=None):
        ...
        self.city_label = tk.Label(self.search_frame, text='', bg='#355E3B', fg='white', anchor='c',
    ...
    def draw_widgets(self):
        ...
        # self.search_frame
        self.search_label = tk.Label(self.search_frame, text='Search City : ', bg='#355E3B', fg='white', anchor='w',
                                     font=('Arial', 11))
